...
def load_checkpoint_stage3_bridge(path):
    ...
    """
    # Keep tensor devices compatible with current runtime.
    # Forcing CPU here can leave gaussians on CPU and crash later in renderer
    # when cameras/tensors are already on CUDA.
