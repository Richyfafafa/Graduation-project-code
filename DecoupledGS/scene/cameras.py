...
class Camera(nn.Module):
    def __init__(self, colmap_id, R, T, FoVx, FoVy, image, gt_alpha_mask, spec_mask,
                 image_name, uid, spec_mask_region_labels=None, spec_mask_region_ids=None,
        ...
        if spec_mask is not None:
            self.spec_mask = spec_mask.to(self.data_device)
        else:
            self.spec_mask = None
        if spec_mask_region_labels is not None:
                                                        
            self.spec_mask_region_labels = spec_mask_region_labels.cpu()
        else:
            self.spec_mask_region_labels = None
        self.spec_mask_region_ids = spec_mask_region_ids
